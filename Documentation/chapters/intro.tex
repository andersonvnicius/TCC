...
%ORGANIZAR, TIRAR A PARTE DE SEGURANÇA VEICULAR
%ESCREVER OS OBJETIVOS QUE VAI AJUDAR
%MOSTRAR A FABRICAÇÃO

%Na contemporaneidade observa-se o constante aumento de importância nos sistemas de segurança em veículos, tanto para a integridade dos passageiros quanto para a segurança dos pedestres. %Atualmente, fatores de segurança no projeto de componentes mecânicos os sobre dimensiona a fim de evitar sua falha em possíveis situações extremas causadas por imprevistos.% Veículos de custo elevado usualmente são equipados com sistemas de segurança ativa, como sistema de controle de tração (TCS) E programa de controle de estabilidade (ESP), esses sistemas evitam equívocos humanos na direção do veículo, porem são dependentes do sensoriamento correto e do controle robusto das grandezas envolvidas. // 

\cite{Nurprasetio} %Nurprasetio (2018) %indica que a performance do veículo se torna o aspecto mais importante a ser definido pelos engenheiros e montadoras uma vez que aumentos de performance nos veículos pode significantemente reduzir o risco de acidentes e melhorar o conforto na direção, também
...
%
%O Trabalho é dividido em seções referentes as principais etapas de desenvolvimento do dispositivo,
%
%O Capitulo 2 faz uma breve apresentação a alguns dispositivos comerciais e trabalhos científicos de maior utilizados como base para o desenvolvimento do dispositivo projetado
%
%O capitulo 3 fala sobre o contexto geral de análise de esforços em aplicações automotivas
%
%O capitulo 4 
%
%
%* Breve explicação sobre cada seção do estudo *
