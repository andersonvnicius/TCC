...
%\section{Segurança Automotiva}
%
%Os sistemas de segurança automotiva são responsáveis por reduzir os efeitos colaterais ou prevenir acidentes, que podem ser causados por erro humano ou condições adversas. Webber (2009) classifica tais os sistemas como sendo ativos e passivos, onde a segurança passiva engloba o potencial de redução dos danos a integridade física aos passageiros do veículo durante uma colisão, e a segurança ativa é a presença de sistemas responsáveis pela prevenção de acidentes.
%
%\begin{figure}[htb]	
%	\caption{\label{fig:Fig_303}Fases de prevenção e mitigação de acidentes}
%	\begin{center}
%		\includegraphics[width=\textwidth]{images/img304.jpg}
%	\end{center}
%	\fonte{**Webber (2009)**}
%\end{figure}
%
%Genta (2008) apresenta os principais tipos de dispositivos de controle, dentre eles, destacam-se: Longitudinal slip control in traction (ASR, anti spin regulator), sistema que detecta o começo do deslizamento de uma roda e reduz a potência vinda do motor , e o ABS, que detecta o começo do deslizamento de uma roda (em frenagem) e diminui os torques de frenagem, ele também aponta que ambos os sistemas deveriam medir o deslizamento do pneu, mas na realidade medem a velocidade das rodas de interesse.
