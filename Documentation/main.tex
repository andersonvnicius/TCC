...
\titulo{\lang{Development of a remote device for torque measuring in rotating shafts}{Desenvolvimento de um dispositivo remoto para medição de torque em eixos rotativos}}
...
\coordenador[\lang{Coordinator}{Coordenador de TCC}]{\brazilword{Leonardo Moreto Elias}, \lang{Phd.}{Dr.}}
...
\data{\lang{17 of march of}{17 de março de} 2022}
...
\palavraschaveufsc{palavraschaveingles}   {Device}
\palavraschaveufsc{palavraschaveportugues}{Dispositivo}

\palavraschaveufsc{palavraschaveingles}   {Sensoring}
\palavraschaveufsc{palavraschaveportugues}{Sensoriamento}

\palavraschaveufsc{palavraschaveingles}   {Torque}
\palavraschaveufsc{palavraschaveportugues}{Torque}
...
%    \include{chapters/chapter_4}
    ...
    \begin{apendicesenv}
        ...
        \include{aftertext/apendice_a0}
        \include{aftertext/apendice_a}
        \include{aftertext/apendice_b}
        \include{aftertext/apendice_c}
        \include{aftertext/apendice_d}
        \include{aftertext/apendice_e}
    \end{apendicesenv}
