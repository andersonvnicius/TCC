...
\titulo{\lang{Development of a remote low cost device to sensor torque loads}{Desenvolvimento de dispositivo remoto de baixo custo para sensoriamento de cargas de torque}}
